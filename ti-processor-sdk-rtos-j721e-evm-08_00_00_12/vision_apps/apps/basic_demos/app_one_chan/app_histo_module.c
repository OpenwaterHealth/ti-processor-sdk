...
vx_status app_send_cmd_histo_write_node(HistoObj *histoObj, vx_uint32 enableChanBitFlag, vx_uint32 start_frame, vx_uint32 num_frames, vx_uint32 num_skip, vx_int32 cam_pair, vx_int32 scan_type, const char* patient_path, const char* sub_path, void* virt_ptr, uint32_t instanceID)
{
    vx_status status = VX_SUCCESS;
