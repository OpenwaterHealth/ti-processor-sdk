/*!
 * @file        app_d3board_gpio.h
 * @brief       GPIO functions and objects for the d3board control server
 * @details     This file defines the GPIO used by the d3 personality card
 *
...
#define GPIO_TP7_PORT_NUM 0
#define GPIO_TP7_PIN_NUM 78

#define GPIO_STROBELIGHT_PORT_NUM 0
#define GPIO_STROBELIGHT_PIN_NUM 64 /* GPIO mapped to pin 13 UART5_TXD_BUFF, UART 5 Transmit Line of the RVP's AUX connector, PADCONFIG 65, GPIO_OUT_DATA45, bits #0*/

#define GPIO_FRAMESYNC_IDX   0
#define GPIO_TP7_IDX         1
#define GPIO_STROBELIGHT_IDX 2
