...
[
    ...
    [ "Build Instructions", "BUILD_INSTRUCTIONS.html", [
      ...
      [ "Quick steps to build vision apps for Linux+TI-RTOS mode", "BUILD_INSTRUCTIONS.html#QUICK_SETUP_STEPS_LINUX_TI_RTOS", [
        [ "Additional steps required for HS devices in Linux+TI-RTOS mode", "BUILD_INSTRUCTIONS.html#QUICK_SETUP_STEPS_LINUX_TI_RTOS_HS_DEVICES", null ]
      ] ],
      [ "Quick steps to build vision apps for QNX+TI-RTOS mode", "BUILD_INSTRUCTIONS.html#QUICK_SETUP_STEPS_QNX_TI_RTOS", null ],
      [ "Quick steps to build vision apps for PC emulation mode", "BUILD_INSTRUCTIONS.html#QUICK_SETUP_STEPS_PC_EMULATION", null ],
    ...
    [ "Run Instructions", "RUN_INSTRUCTIONS.html", [
      ...
      [ "Run vision apps on EVM in QNX+RTOS mode (via SD card boot)", "RUN_INSTRUCTIONS.html#run_steps_qnx", [
        ...
        [ "Step 2: Copy test data to SD card (one time only)", "RUN_INSTRUCTIONS.html#run_step_copy_test_data_qnx", null ],
        [ "Step 3a: Copy executable files to SD card for boot using SPL+Uboot(first time and each time you want to run updated applications)", "RUN_INSTRUCTIONS.html#run_step_copy_files_qnx_a", null ],
        [ "Step 3b: Copy executable files to SD card for boot using MMCSD+SBL(first time and each time you want to run updated applications)", "RUN_INSTRUCTIONS.html#run_step_copy_files_qnx_b", null ],
        [ "Step 3c: Copy executable files to SD card for boot using OSPI+SBL(first time and each time you want to run updated applications)", "RUN_INSTRUCTIONS.html#run_step_copy_files_qnx_c", null ],
    ...
    [ "Trouble shooting build and run errors", "BUILD_TROUBLE_SHOOTING.html", [
      [ "Trouble shooting build errors", "BUILD_TROUBLE_SHOOTING.html#autotoc_md13", [
        [ "I see the error \"ERROR: /home/<user>/ti-processor-sdk-rtos-j721e-evm-xx_xx_xx_xx/targetfs//usr/include not found !!!\" when building vision_apps", "BUILD_TROUBLE_SHOOTING.html#autotoc_md14", null ],
