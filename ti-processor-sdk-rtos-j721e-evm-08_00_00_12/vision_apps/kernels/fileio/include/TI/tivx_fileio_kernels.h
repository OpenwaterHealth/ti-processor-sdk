...
/*! \brief Kernel Name: Write histogram
 *  \see group_vision_apps_kernels_fileio
 */
#define TIVX_KERNEL_WRITE_HISTOGRAM_NAME     "com.ti.fileio.write.vx_histogram"
...
#define TIVX_FILEIO_HISTO_MAX_NUM_CHANNELS (8U)
...
typedef struct
{
    ...
    vx_uint32 num_skip;
    vx_int32 scan_type;     // 0 full, 1 is test
    uint32_t enableChanBitFlag;
    char patient_path[64];
    char sub_path[32];
} tivxFileIOWriteCmd;
