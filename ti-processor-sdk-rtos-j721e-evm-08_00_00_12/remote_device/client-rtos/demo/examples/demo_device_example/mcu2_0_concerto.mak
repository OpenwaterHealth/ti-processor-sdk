...
ifeq ($(RTOS),SYSBIOS)
	XDC_BLD_FILE = $($(_MODULE)_SDIR)/mcu2_0_sysbios.bld
	ifeq ($(SOC),j721e)
		XDC_CFG_FILE = $($(_MODULE)_SDIR)/j721e_mcu2_0_sysbios.cfg
		XDC_PLATFORM = "ti.platforms.cortexR:J7ES_MAIN"
		LINKER_CMD_FILES +=  $($(_MODULE)_SDIR)/j721e_mcu2_0_sysbios.lds
	endif
	ifeq ($(SOC),j7200)
		XDC_CFG_FILE = $($(_MODULE)_SDIR)/j7200_mcu2_0_sysbios.cfg
		XDC_PLATFORM = "ti.platforms.cortexR:J7200_MAIN"
		LINKER_CMD_FILES +=  $($(_MODULE)_SDIR)/j7200_mcu2_0_sysbios.lds
	endif
endif
ifeq ($(RTOS),FREERTOS)
