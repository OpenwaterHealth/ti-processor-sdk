...
override PKGDIR = ti/utils/profiling
...
package.mak: profilingver.h.xdt
endif
...
package/%.xdc.inc package/%_ti.utils.profiling.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.utils.profiling" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.utils.profiling $@
...
.PHONY: release,utils_1_0_0_8
ifeq (,$(MK_NOGENDEPS))
-include package/rel/utils_1_0_0_8.tar.dep
endif
package/rel/utils_1_0_0_8/ti/utils/profiling/package/package.rel.xml: package/package.bld.xml
package/rel/utils_1_0_0_8/ti/utils/profiling/package/package.rel.xml: package/build.cfg
package/rel/utils_1_0_0_8/ti/utils/profiling/package/package.rel.xml: package/package.xdc.inc
package/rel/utils_1_0_0_8/ti/utils/profiling/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/utils_1_0_0_8/ti/utils/profiling/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

./packages/utils_1_0_0_8.tar: package/rel/utils_1_0_0_8.xdc.inc package/rel/utils_1_0_0_8/ti/utils/profiling/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/utils_1_0_0_8.xdc.inc,package/rel/utils_1_0_0_8.tar.dep)


release release,utils_1_0_0_8: all ./packages/utils_1_0_0_8.tar
clean:: .clean
	-$(RM) ./packages/utils_1_0_0_8.tar
	-$(RM) package/rel/utils_1_0_0_8.xdc.inc
	-$(RM) package/rel/utils_1_0_0_8.tar.dep
