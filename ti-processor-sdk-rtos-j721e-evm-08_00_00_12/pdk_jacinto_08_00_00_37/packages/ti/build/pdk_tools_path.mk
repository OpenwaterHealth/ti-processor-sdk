...
################################################################################
  ...
  PDK_VERSION_STR=_jacinto_08_00_00_37
ifeq ($(PDK_VERSION),)
  PDK_VERSION_STR=_jacinto_08_00_00_37
endif
...
ifeq ($(BOARD),$(filter $(BOARD), am65xx_evm am65xx_idk j721e_evm j7200_evm j721s2_evm am64x_evm am64x_svb tpr12_qt tpr12_evm awr294x_evm d3_rvp))
