...
override PKGDIR = ti/drv/sciclient
...
package.mak: sciclientver.h.xdt
endif
...
package/%.xdc.inc package/%_ti.drv.sciclient.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.drv.sciclient" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.drv.sciclient $@
...
.PHONY: release,ti_drv_sciclient
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_drv_sciclient.tar.dep
endif
package/rel/ti_drv_sciclient/ti/drv/sciclient/package/package.rel.xml: package/package.bld.xml
package/rel/ti_drv_sciclient/ti/drv/sciclient/package/package.rel.xml: package/build.cfg
package/rel/ti_drv_sciclient/ti/drv/sciclient/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_drv_sciclient/ti/drv/sciclient/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_drv_sciclient/ti/drv/sciclient/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_drv_sciclient.tar: package/rel/ti_drv_sciclient.xdc.inc package/rel/ti_drv_sciclient/ti/drv/sciclient/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_drv_sciclient.xdc.inc,package/rel/ti_drv_sciclient.tar.dep)


release release,ti_drv_sciclient: all ti_drv_sciclient.tar
clean:: .clean
	-$(RM) ti_drv_sciclient.tar
	-$(RM) package/rel/ti_drv_sciclient.xdc.inc
	-$(RM) package/rel/ti_drv_sciclient.tar.dep
