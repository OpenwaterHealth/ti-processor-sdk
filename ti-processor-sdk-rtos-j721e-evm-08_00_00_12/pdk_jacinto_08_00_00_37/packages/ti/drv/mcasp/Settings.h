...
static inline xdc_Bool ti_drv_mcasp_Settings_Module_hasMask(void)
{
    return (xdc_Bool)(ti_drv_mcasp_Settings_Module__diagsMask__C != (CT__ti_drv_mcasp_Settings_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_drv_mcasp_Settings_Module_getMask(void)
{
    return (ti_drv_mcasp_Settings_Module__diagsMask__C != (CT__ti_drv_mcasp_Settings_Module__diagsMask)NULL) ? *ti_drv_mcasp_Settings_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_drv_mcasp_Settings_Module_setMask(xdc_Bits16 mask)
{
    if (ti_drv_mcasp_Settings_Module__diagsMask__C != (CT__ti_drv_mcasp_Settings_Module__diagsMask)NULL) {
