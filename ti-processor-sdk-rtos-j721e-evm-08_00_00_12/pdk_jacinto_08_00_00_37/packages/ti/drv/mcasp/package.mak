...
package/%.xdc.inc package/%_ti.drv.mcasp.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.drv.mcasp" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.drv.mcasp $@
...
.PHONY: release,mcasp_1_1_0_15
ifeq (,$(MK_NOGENDEPS))
-include package/rel/mcasp_1_1_0_15.tar.dep
endif
package/rel/mcasp_1_1_0_15/ti/drv/mcasp/package/package.rel.xml: package/package.bld.xml
package/rel/mcasp_1_1_0_15/ti/drv/mcasp/package/package.rel.xml: package/build.cfg
package/rel/mcasp_1_1_0_15/ti/drv/mcasp/package/package.rel.xml: package/package.xdc.inc
package/rel/mcasp_1_1_0_15/ti/drv/mcasp/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/mcasp_1_1_0_15/ti/drv/mcasp/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

./packages/mcasp_1_1_0_15.tar: package/rel/mcasp_1_1_0_15.xdc.inc package/rel/mcasp_1_1_0_15/ti/drv/mcasp/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/mcasp_1_1_0_15.xdc.inc,package/rel/mcasp_1_1_0_15.tar.dep)


release release,mcasp_1_1_0_15: all ./packages/mcasp_1_1_0_15.tar
clean:: .clean
	-$(RM) ./packages/mcasp_1_1_0_15.tar
	-$(RM) package/rel/mcasp_1_1_0_15.xdc.inc
	-$(RM) package/rel/mcasp_1_1_0_15.tar.dep
