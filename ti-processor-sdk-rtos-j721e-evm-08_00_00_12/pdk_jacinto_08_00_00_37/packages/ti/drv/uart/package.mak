...
package/%.xdc.inc package/%_ti.drv.uart.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.drv.uart" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.drv.uart $@
...
.PHONY: release,uart_1_0_0_16
ifeq (,$(MK_NOGENDEPS))
-include package/rel/uart_1_0_0_16.tar.dep
endif
package/rel/uart_1_0_0_16/ti/drv/uart/package/package.rel.xml: package/package.bld.xml
package/rel/uart_1_0_0_16/ti/drv/uart/package/package.rel.xml: package/build.cfg
package/rel/uart_1_0_0_16/ti/drv/uart/package/package.rel.xml: package/package.xdc.inc
package/rel/uart_1_0_0_16/ti/drv/uart/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/uart_1_0_0_16/ti/drv/uart/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

./packages/uart_1_0_0_16.tar: package/rel/uart_1_0_0_16.xdc.inc package/rel/uart_1_0_0_16/ti/drv/uart/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/uart_1_0_0_16.xdc.inc,package/rel/uart_1_0_0_16.tar.dep)


release release,uart_1_0_0_16: all ./packages/uart_1_0_0_16.tar
clean:: .clean
	-$(RM) ./packages/uart_1_0_0_16.tar
	-$(RM) package/rel/uart_1_0_0_16.xdc.inc
	-$(RM) package/rel/uart_1_0_0_16.tar.dep
