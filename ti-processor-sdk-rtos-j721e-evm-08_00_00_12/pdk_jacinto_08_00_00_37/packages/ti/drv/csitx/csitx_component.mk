...
drvcsitx_SOCLIST         = j721e
drvcsitx_BOARDLIST       = j721e_evm
drvcsitx_j721e_CORELIST  = mcu2_0 mcu2_1
...
CSITX_TRANSMIT_TESTAPP_MACRO_LIST := $(foreach curos, $(drvcsitx_RTOS_LIST), $(call CSITX_TRANSMIT_TESTAPP_RULE,$(curos)))
