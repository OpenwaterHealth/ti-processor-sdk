...
COMP_LIST_COMMON = fvid2 csirx csitx
...
# Common source files and CFLAGS across all platforms and cores
PACKAGE_SRCS_COMMON = .
SRCS_COMMON += csitx_transmit_test_main.c csirx_capture_test.c
CFLAGS_LOCAL_COMMON += $(PDK_CFLAGS) $(CSITX_CFLAGS) $(CFLAGS_OS_DEFINES)
