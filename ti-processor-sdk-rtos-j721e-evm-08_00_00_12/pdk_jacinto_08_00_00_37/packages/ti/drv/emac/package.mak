...
package/%.xdc.inc package/%_ti.drv.emac.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.drv.emac" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.drv.emac $@
...
.PHONY: release,emac_1_0_3_18
ifeq (,$(MK_NOGENDEPS))
-include package/rel/emac_1_0_3_18.tar.dep
endif
package/rel/emac_1_0_3_18/ti/drv/emac/package/package.rel.xml: package/package.bld.xml
package/rel/emac_1_0_3_18/ti/drv/emac/package/package.rel.xml: package/build.cfg
package/rel/emac_1_0_3_18/ti/drv/emac/package/package.rel.xml: package/package.xdc.inc
package/rel/emac_1_0_3_18/ti/drv/emac/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/emac_1_0_3_18/ti/drv/emac/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

./packages/emac_1_0_3_18.tar: package/rel/emac_1_0_3_18.xdc.inc package/rel/emac_1_0_3_18/ti/drv/emac/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/emac_1_0_3_18.xdc.inc,package/rel/emac_1_0_3_18.tar.dep)


release release,emac_1_0_3_18: all ./packages/emac_1_0_3_18.tar
clean:: .clean
	-$(RM) ./packages/emac_1_0_3_18.tar
	-$(RM) package/rel/emac_1_0_3_18.xdc.inc
	-$(RM) package/rel/emac_1_0_3_18.tar.dep
