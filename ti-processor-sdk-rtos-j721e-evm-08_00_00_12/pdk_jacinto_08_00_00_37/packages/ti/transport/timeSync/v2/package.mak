...
override PKGDIR = ti/transport/timeSync/v2
...
package.mak: timeSync_ver.h.xdt
endif
...
package/%.xdc.inc package/%_ti.transport.timeSync.v2.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.transport.timeSync.v2" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.transport.timeSync.v2 $@
...
.PHONY: release,timeSync_1_0_0_0
ifeq (,$(MK_NOGENDEPS))
-include package/rel/timeSync_1_0_0_0.tar.dep
endif
package/rel/timeSync_1_0_0_0/ti/transport/timeSync/v2/package/package.rel.xml: package/package.bld.xml
package/rel/timeSync_1_0_0_0/ti/transport/timeSync/v2/package/package.rel.xml: package/build.cfg
package/rel/timeSync_1_0_0_0/ti/transport/timeSync/v2/package/package.rel.xml: package/package.xdc.inc
package/rel/timeSync_1_0_0_0/ti/transport/timeSync/v2/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/timeSync_1_0_0_0/ti/transport/timeSync/v2/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

./packages/timeSync_1_0_0_0.tar: package/rel/timeSync_1_0_0_0.xdc.inc package/rel/timeSync_1_0_0_0/ti/transport/timeSync/v2/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/timeSync_1_0_0_0.xdc.inc,package/rel/timeSync_1_0_0_0.tar.dep)


release release,timeSync_1_0_0_0: all ./packages/timeSync_1_0_0_0.tar
clean:: .clean
	-$(RM) ./packages/timeSync_1_0_0_0.tar
	-$(RM) package/rel/timeSync_1_0_0_0.xdc.inc
	-$(RM) package/rel/timeSync_1_0_0_0.tar.dep
